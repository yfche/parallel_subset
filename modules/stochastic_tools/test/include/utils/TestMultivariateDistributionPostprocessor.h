 ...
 */
class TestMultivariateDistributionPostprocessor : public GeneralPostprocessor
{
public:
  static InputParameters validParams();

  TestMultivariateDistributionPostprocessor(const InputParameters & parameters);
...
protected:
  ...
  const MultivariateDistribution & _distribution;
